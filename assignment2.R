...
ches_2017_modified <- read_csv("datasets/ches_2017_modified.csv", skip = 4)# the first 4 lines are not containing anything so with skip we tell are to skip those
